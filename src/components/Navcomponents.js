                ...
                <div className="row justify-content-center bg-info">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hi! There, I am Uday Khunt</h1>
            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)"}}>
                        <h1>
                            <div class="display-4">Uday Khunt</div>
                            <div class="lead text-muted"><i class="bi bi-file-earmark-person"></i>Learning</div>
                        </h1>
                        <hr />
                        <div class="contact">
                            <p class="lead pt-0">Currently learning...</p>
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me : 
                                <a href="mailto:udaykhunt02@gmail.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            <span class="lead"><i class="bi bi-geo-fill"></i> Gujarat</span>
                            <br /><br />
                            <span class="lead fw-900"><i class="bi bi-at"></i> Connect with me : </span>
                            <p class="btn-group">
                                <a href="https://www.linkedin.com/in/uday-khunt-4249a3250/" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> LinkedIn</a>
                                <a href="https://github.com/UdayKhunt" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                                <a href="https://leetcode.com/ubkubkubk/" target="_blank" class="btn btn-sm btn-danger fw-bold">LeetCode</a>
                            </p>
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/UdayKhunt" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-primary border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://leetcode.com/ubkubkubk/" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                        ...
                        <div class="list-group">
                            <div class="list-group-item py-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="https://leetcode.com/problems/maximum-subarray/submissions/903964724/" target="_blank" class="btn btn-outline-success active">View the Code</a>
                                </div>
                            </div>
                            ...
                            <div class="list-group-item py-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <small>Difficulty : Easy</small>
                                    <a href="https://leetcode.com/problems/two-sum/submissions/904120544/" target="_blank" class="btn btn-outline-success active">View the Code</a>
                                </div>
                            </div>
                        </div>
                    </div>
